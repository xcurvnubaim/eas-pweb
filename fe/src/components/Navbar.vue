                    ...
                    <div class="relative ml-3">
                        <div>
                            <button @click="showDropdown" type="button"
                                ...
                                <img class="h-8 w-8 rounded-full" src="../assets/user-solid.svg" alt="">
                            </button>
                        </div>
                        ...
                        <div v-if="isVisible"
                            ...
                            <button v-if="authStore.isAuthenticated" @click="logout()" class="block px-4 py-2 text-sm text-gray-700"
                                role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
                            <a v-if="!authStore.isAuthenticated" href="/auth/register" class="block px-4 py-2 text-sm text-gray-700"
                                role="menuitem" tabindex="-1" id="user-menu-item-2">Register</a>
                            <a v-if="!authStore.isAuthenticated" href="/auth/login" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
