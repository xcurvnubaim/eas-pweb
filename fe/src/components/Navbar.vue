...
const getMe = async () => {
    try {
        const response = await axios.get(import.meta.env.VITE_API_URL + '/users/me', { withCredentials: true });
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div v-if="isVisible"
                            ...
                            <button v-if="me" @click="logout()" class="block px-4 py-2 text-sm text-gray-700"
                                role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
                            <a v-if="!me" href="/auth/register" class="block px-4 py-2 text-sm text-gray-700"
                                role="menuitem" tabindex="-1" id="user-menu-item-2">Register</a>
                            <a v-if="!me" href="/auth/login" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
