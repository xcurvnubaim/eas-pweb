...
const getData = async () => {
    try {
        ...
        const response = await axios.get(import.meta.env.VITE_API_URL + '/products?where[tenant_id][equals]=' + myId.value , { withCredentials: true });
...
<template>
    <div class="w-screen">
        <div class="flex justify-center">
            <h1 class="text-4xl font-bold text-red-500">Channel</h1>
        </div>
